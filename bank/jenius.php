...
class WC_Gateway_Jenius extends WC_Gateway_BACS {
	function __construct() {
		$this->id = "jenius";
		$this->method_title = __( "Jenius", 'woocommerce' );
		$this->method_description = __( "Pembayaran melalui Jenius", 'woocommerce' );
		$this->title = __( "Transfer Jenius", 'woocommerce' );
 ...
 public function init_form_fields() {
    $this->form_fields = array(
        'enabled' => array(
            ...
            'label'     => __( 'Enable <strong>Jenius</strong> Transfer Payment Method', 'woocommerce' ),
            'type'      => 'checkbox',
            'default'   => 'no',
        ),
        'title' => array(
            ...
            'default'   => __( 'Transfer Jenius', 'woocommerce' ),
        ),
        'enable_icon' => array(
...
public function process_payment( $order_id ) {
    ...
    $order->update_status( 'on-hold', __( 'Menunggu Pembayaran melalui Jenius', 'woocommerce' ) );
...
public function email_instructions( $order, $sent_to_admin, $plain_text = false ) {
    ...
    if ( ! $sent_to_admin && 'jenius' === $order->payment_method && $order->has_status( 'on-hold' ) ) {
        if ( $this->instructions ) {
