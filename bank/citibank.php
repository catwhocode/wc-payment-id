...
class WC_Gateway_Citibank extends WC_Gateway_BACS {
	function __construct() {
		$this->id = "citibank";
		$this->method_title = __( "Citibank", 'woocommerce' );
		$this->method_description = __( "Pembayaran melalui Citibank", 'woocommerce' );
		$this->title = __( "Transfer Citibank", 'woocommerce' );
		$this->icon = $this->enable_icon = 'yes' === $this->get_option( 'enable_icon' ) ? plugins_url('assets/logo-citibank.png',__FILE__) : null;
 ...
 public function init_form_fields() {
    $this->form_fields = array(
        'enabled' => array(
            ...
            'label'     => __( 'Enable <strong>Citibank</strong> Transfer Payment Method', 'woocommerce' ),
            'type'      => 'checkbox',
            'default'   => 'no',
        ),
        'title' => array(
            ...
            'default'   => __( 'Transfer Citibank', 'woocommerce' ),
        ),
        'enable_icon' => array(
...
public function process_payment( $order_id ) {
    ...
    $order->update_status( 'on-hold', __( 'Menunggu Pembayaran melalui Citibank', 'woocommerce' ) );
...
public function email_instructions( $order, $sent_to_admin, $plain_text = false ) {
    ...
    if ( ! $sent_to_admin && 'citibank' === $order->payment_method && $order->has_status( 'on-hold' ) ) {
        if ( $this->instructions ) {
