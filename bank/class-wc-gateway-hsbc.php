...
class WC_Gateway_HSBC extends WC_Gateway_BACS {
    ...
    add_action( 'woocommerce_thankyou_hsbc', array( $this, 'thankyou_page' ) );
    add_action( 'woocommerce_email_before_order_table', array( $this, 'email_instructions' ), 10, 3 );
     

    // BACS account fields shown on the thanks page and in emails
     $this->account_details = get_option( 'woocommerce_hsbc_accounts',
        array(
            array(
...
public function save_account_details() {
    ...
    update_option( 'woocommerce_hsbc_accounts', $accounts );
...
public function email_instructions( $order, $sent_to_admin, $plain_text = false ) {
    ...
    if ( ! $sent_to_admin && 'hsbc' === $order->get_payment_method() && $order->has_status( 'on-hold' ) ) {
        if ( $this->instructions ) {
