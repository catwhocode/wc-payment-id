...
class WC_Gateway_HSBC extends WC_Gateway_BACS {
	function __construct() {
		$this->id = "hsbc";
		$this->method_title = __( "HSBC", 'woocommerce' );
		$this->method_description = __( "Pembayaran melalui HSBC", 'woocommerce' );
		$this->title = __( "Transfer HSBC", 'woocommerce' );
 ...
 public function init_form_fields() {
    $this->form_fields = array(
        'enabled' => array(
            ...
            'label'     => __( 'Enable <strong>HSBC</strong> Transfer Payment Method', 'woocommerce' ),
            'type'      => 'checkbox',
            'default'   => 'no',
        ),
        'title' => array(
            ...
            'default'   => __( 'Transfer HSBC', 'woocommerce' ),
        ),
        'enable_icon' => array(
...
public function process_payment( $order_id ) {
    ...
    $order->update_status( 'on-hold', __( 'Menunggu Pembayaran melalui HSBC', 'woocommerce' ) );
...
public function email_instructions( $order, $sent_to_admin, $plain_text = false ) {
    ...
    if ( ! $sent_to_admin && 'hsbc' === $order->payment_method && $order->has_status( 'on-hold' ) ) {
        if ( $this->instructions ) {
