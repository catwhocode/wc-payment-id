...
class WC_Gateway_Digibank extends WC_Gateway_BACS {
	function __construct() {
		$this->id = "digibank";
		$this->method_title = __( "Digibank", 'woocommerce' );
		$this->method_description = __( "Pembayaran melalui Digibank", 'woocommerce' );
		$this->title = __( "Transfer Digibank", 'woocommerce' );
 ...
 public function init_form_fields() {
    $this->form_fields = array(
        'enabled' => array(
            ...
            'label'     => __( 'Enable <strong>Digibank</strong> Transfer Payment Method', 'woocommerce' ),
            'type'      => 'checkbox',
            'default'   => 'no',
        ),
        'title' => array(
            ...
            'default'   => __( 'Transfer Digibank', 'woocommerce' ),
        ),
        'enable_icon' => array(
...
public function process_payment( $order_id ) {
    ...
    $order->update_status( 'on-hold', __( 'Menunggu Pembayaran melalui Digibank', 'woocommerce' ) );
...
public function email_instructions( $order, $sent_to_admin, $plain_text = false ) {
    ...
    if ( ! $sent_to_admin && 'digibank' === $order->payment_method && $order->has_status( 'on-hold' ) ) {
        if ( $this->instructions ) {
